...
// const btnOpenModal = document.getElementsByClassName("edit__style");
// console.log(btnOpenModal);


// const arrayTest = Array.from(btnOpenModal);
...
//     const button = arrayTest[i];
//     console.log(button)
//     arrayTest[i].addEventListener("click", () => {
//         test();
//     });
// }
